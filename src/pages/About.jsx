...
const About = () => {
  return (
    <section className="max-container">
      <h1 className="head-text">Hello , I'm <span className="blue-gradient_text font-semibold drop-shadow">George</span></h1> 
            ...
            {experiences.map((experience) =>(
              ...
              >
                <div>
                  ...
                  <ul className='my-5 list-disc mr-6 space-y-2'>
                    {experience.points.map((point,index)=>(
                        <li key={`experience-poin-${index}`} className='text-black-500/50 font-normal pl- text-sm'>
                          {point}
                        </li>
                    ))}
                  </ul>
